...
namespace AzureServiceBusToSQL
{
    public static class ServiceBusTriggerXML
    {
        ...
        public static void Run([ServiceBusTrigger("xmlpayload", "training202202", Connection = "ServiceBusConnectionString")] string mySbMsg, Int32 deliveryCount, DateTime enqueuedTimeUtc, string messageId, ILogger log)
        {
