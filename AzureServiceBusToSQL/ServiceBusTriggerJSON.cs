...
namespace AzureServiceBusToSQL
{
    public static class ServiceBusTriggerJSON
    {
        ...
        public static void Run([ServiceBusTrigger("jsonpayload", "training202202", Connection = "ServiceBusConnectionString")]string mySbMsg, Int32 deliveryCount,DateTime enqueuedTimeUtc, string messageId, ILogger log)
        {
